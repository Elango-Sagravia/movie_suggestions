...
import changeFormat, { changeFormatDate } from "@/components/dateFormat";
  ...
  return (
    <div className="flex mt-8 min-h-96 md:min-h-[410px]">
      ...
      <Link
        ...
        className="flex-1 bg-nl_background text-black flex flex-col justify-center py-8"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
      >
        <div className="flex items-center gap-2 py-4 px-4 sm:px-16 text-nl_background ">
          ...
          <p className="text-black rounded-full bg-nl_sec_background w-[5px] h-[5px]"></p>
          <p className="text-black text-[12px] font-bold uppercase">
