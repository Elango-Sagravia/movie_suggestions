...
async function sendEmail(email, uniqueId, email_uniqueid) {
  let mailOptions = {
    from: '"Movie Suggestions" <no-reply@newsletter.moviesuggestions.com>', // Sender email address
...
export async function POST(request) {
  try {
    ...
    await sendEmail(email, uniqueId, email_uniqueid);
    const emailListData = {
    ...
    await fetch("https://www.moviesuggestions.com/api/emails/emails_list_add", {
      method: "POST",
      headers: {
